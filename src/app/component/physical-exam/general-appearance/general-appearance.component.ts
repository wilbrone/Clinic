...
@Component({
  selector: 'app-general-appearance',
  templateUrl: './general-appearance.component.html',
  styleUrls: ['./general-appearance.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class GeneralAppearanceComponent implements OnInit {
